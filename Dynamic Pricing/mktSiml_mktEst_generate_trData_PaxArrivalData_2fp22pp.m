...
nEpisodes = 100000; % 85000; % 50000; % 5000; % 500000; % 400000; % 200000; % 1000; % 200000; % 10000; % 200000; % 25000; % number of episodes used for training the DRL agent
...
% % % % %                              repelem(0.0001,1,180), cncRate_fp_last2timeSteps_allExp(cancelProbsSetting,1), cncRate_fp_last2timeSteps_allExp(cancelProbsSetting,1)];
        ...
        % fileName = 'testData_cnc' + string(cancelProbsSetting) + '_fcArrivals' + string(meanNarrivalsSetting) + '_2fp22pp_mktSiml_mktEst'; % to generate test data, comment out the 
