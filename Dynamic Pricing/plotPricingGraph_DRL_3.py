...
plt.plot(t1, np.array(fares_fc2)*100, label='Low fare product') # , t1, fares_fc3)
# plt.title('dynamicPricingGraph_bestPerformance')
##plt.legend(loc='best')
...
plt.tight_layout()
# plt.show()
plt.savefig(outputDir + '/plots_pricing_paxArrival.pdf')
plt.savefig(outputDir + '/plots_pricing_paxArrival.png')
####plt.show()
