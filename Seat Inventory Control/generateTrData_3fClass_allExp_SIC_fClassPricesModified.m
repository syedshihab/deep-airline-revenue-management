...
% demands of the three fare classes are stochastic because the inter-arrival times of the passengers of difderent fare classes follows an exponential random distribution
...
fClassPrices = [6, 4, 2.5]; % Reward scaled; $400, $200 and $100
...
fClassMeanArrivals_allExp = [16, 40, 100;...
                             25, 40, 90;...
                             30, 40, 80]; % the mean number of passenger arrivals of the different fare classes in three different settings (experiments); 
...
for meanNarrivalsSetting=3:3 % 1:3
    for cancelProbsSetting=1:1 % 1:3        
        ...
        % fileName = 'trainingData_cnc' + string(4) + '_fcArrivals' + string(4); % to generate training data
        fileName = 'testData_cnc' + string(4) + '_fcArrivals' + string(4); % to generate test data, comment out the 
